...
char* changeNavParemeters(char* htmlTemplate) {
	...
	char HTML_REPLACE_NAV[] = "Dll_count\" placeholder=\"Dll count\"/></li><li><input class=\"Process_count\" placeholder=\"Process count\"/>PRCCNT</li><li><input class=\"Memory_Avg\" placeholder =\"Memory Avg\"/>MEMAVG</li>";
